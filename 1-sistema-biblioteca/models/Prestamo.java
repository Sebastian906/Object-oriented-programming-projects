...
public class Prestamo {
    ...
    public int calcularDiasRestantes() {
        ...
        return (int) ChronoUnit.DAYS.between(fechaActual, fechaDevolucionEsperada);
    }
    ...
    public String devolver() {
        ...
        if (fechaDevolucionReal.isAfter(fechaDevolucionEsperada)) {
            long diasRetraso = ChronoUnit.DAYS.between(fechaDevolucionEsperada, fechaDevolucionReal);
    ...
    public String toString() {
        return """
               ...
               "\n  Devolución Real: " + (fechaDevolucionReal != null ? fechaDevolucionReal : "Pendiente") +
               "\n  Estado: " + estado +
               "\n}";
    }
}
